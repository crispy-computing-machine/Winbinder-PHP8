...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_tab_set_closable, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, tab, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, closable, MAY_BE_BOOL|MAY_BE_NULL, "1")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_tab_close, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, tab, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_tab_move, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, from_tab, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, to_tab, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_tab_pin, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, tab, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, pinned, MAY_BE_BOOL|MAY_BE_NULL, "1")
ZEND_END_ARG_INFO()
