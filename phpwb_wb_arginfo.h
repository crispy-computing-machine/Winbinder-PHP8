...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_exec, 0, 1, IS_LONG, 0)
    ...
    ZEND_ARG_TYPE_MASK(0, show, MAY_BE_BOOL|MAY_BE_NULL, "null")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_wait, 0, 0, MAY_BE_NULL|MAY_BE_LONG)
	ZEND_ARG_TYPE_MASK(0, wbObject, MAY_BE_LONG|MAY_BE_NULL, "null")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_load_image, 0, 1, MAY_BE_NULL|MAY_BE_LONG)
	...
	ZEND_ARG_TYPE_MASK(0, index, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, icon_type, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_image_data, 0, 1, MAY_BE_NULL|MAY_BE_STRING)
	ZEND_ARG_TYPE_INFO(0, bitmap, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, compress4to3, MAY_BE_LONG|MAY_BE_BOOL|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_draw_line, 0, 6,_IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, color, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, linewidth, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, linestyle, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_draw_rect, 0, 6,_IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, height, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, color, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, filled, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, linewidth, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, linestyle, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_draw_text, 0, 4,_IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_INFO(0, x, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, y, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, width, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, height, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, font, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, flags, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_draw_image, 0, 2,_IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, handle, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, bitmap, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, x, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, y, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, width, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, height, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, transparent_colour, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, offset_x, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, offset_y, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_value, 0, 1, MAY_BE_NULL|MAY_BE_BOOL|MAY_BE_ARRAY)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, item, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, subitem, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_begin_refresh, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, fps, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, x, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, y, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, width, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, height, MAY_BE_LONG|MAY_BE_NULL, "null")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_image, 0, 2, _IS_BOOL, 0)
	...
	ZEND_ARG_TYPE_MASK(0, colour, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, index, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, parameter, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_create_control, 0, 2,  MAY_BE_NULL|MAY_BE_LONG|MAY_BE_BOOL)
	...
	ZEND_ARG_TYPE_MASK(0, width, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, height, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, id, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, style, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, parameter, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, tab, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_create_statusbar_items, 0, 2, MAY_BE_NULL|MAY_BE_BOOL|MAY_BE_ARRAY)
	...
	ZEND_ARG_TYPE_MASK(0, clear, MAY_BE_LONG|MAY_BE_NULL, "null")
	ZEND_ARG_TYPE_MASK(0, parameter, MAY_BE_LONG|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
