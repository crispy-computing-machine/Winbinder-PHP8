...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_vlc_is_available, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_vlc_create_player, 0, 1, MAY_BE_NULL|MAY_BE_LONG)
	ZEND_ARG_TYPE_INFO(0, vlcHostControl, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_vlc_destroy_player, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, vlcPlayer, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_vlc_set_media, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, vlcPlayer, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, mediaPathOrUrl, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_vlc_pause, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, vlcPlayer, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_vlc_stop, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, vlcPlayer, IS_LONG, 0)
ZEND_END_ARG_INFO()
