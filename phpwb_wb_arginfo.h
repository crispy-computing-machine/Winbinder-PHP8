...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_color_scheme, 0, 1, _IS_BOOL, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_chart_data, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, xData, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, yData, IS_ARRAY, 0)
	ZEND_ARG_TYPE_MASK(0, chartType, MAY_BE_LONG|MAY_BE_NULL, "WBC_CHART_LINE")
	ZEND_ARG_TYPE_MASK(0, showAverage, MAY_BE_BOOL|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()
