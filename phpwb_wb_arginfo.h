...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_screenshot, 0, 2, MAY_BE_NULL|MAY_BE_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, filename, MAY_BE_STRING|MAY_BE_NULL, "0")
	ZEND_ARG_TYPE_MASK(0, savetofile, MAY_BE_LONG|MAY_BE_BOOL|MAY_BE_NULL, "false")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_handler, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, parameter, MAY_BE_ARRAY|MAY_BE_STRING, "0")
ZEND_END_ARG_INFO()
