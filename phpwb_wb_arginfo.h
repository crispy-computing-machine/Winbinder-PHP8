...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_theme, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_MASK(0, wbObject, MAY_BE_NULL|MAY_BE_LONG, "null")
	ZEND_ARG_TYPE_INFO(0, theme, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_get_theme, 0, 0, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, wbObject, MAY_BE_NULL|MAY_BE_LONG, "null")
ZEND_END_ARG_INFO()


ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_theme_color, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, theme, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, role, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, color, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_get_theme_color, 0, 2, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, theme, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, role, IS_LONG, 0)
ZEND_END_ARG_INFO()
