...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_message_box, 0, 2, MAY_BE_LONG|MAY_BE_BOOL|MAY_BE_NULL)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_quiet_message_box, 0, 2, MAY_BE_LONG|MAY_BE_BOOL|MAY_BE_NULL)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, message, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, title, IS_STRING, 1, "null")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, style, IS_LONG, 0, "0")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_watch_path, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO(0, path, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, recursive, _IS_BOOL, 0, "false")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, debounce, IS_LONG, 0, "200")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_unwatch_path, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, watchId, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_watch_poll, 0, 0, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, timeout, IS_LONG, 0, "0")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, maxEvents, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_attach_tooltip, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, text, MAY_BE_STRING|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_remove_tooltip, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_show_tooltip_balloon, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, text, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, severity, MAY_BE_STRING|MAY_BE_LONG|MAY_BE_NULL, "\"info\"")
	ZEND_ARG_TYPE_MASK(0, title, MAY_BE_STRING|MAY_BE_NULL, "null")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_hide_tooltip, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_panel_toggle, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_panel_set_header, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, text, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, icon, MAY_BE_NULL|MAY_BE_LONG|MAY_BE_STRING, "null")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_datetime, 0, 1, MAY_BE_NULL|MAY_BE_LONG|MAY_BE_STRING)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, as_iso_string, MAY_BE_BOOL|MAY_BE_NULL, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_datetime, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, datetime_value, MAY_BE_NULL|MAY_BE_LONG|MAY_BE_STRING, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_datetime_bounds, 0, 1, MAY_BE_NULL|MAY_BE_ARRAY)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, as_iso_string, MAY_BE_BOOL|MAY_BE_NULL, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_datetime_bounds, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, min_datetime, MAY_BE_NULL|MAY_BE_LONG|MAY_BE_STRING, "0")
	ZEND_ARG_TYPE_MASK(0, max_datetime, MAY_BE_NULL|MAY_BE_LONG|MAY_BE_STRING, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_datetime_format, 0, 1, MAY_BE_NULL|MAY_BE_STRING)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_datetime_format, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, format, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_get_datetime_empty, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_datetime_empty, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, empty, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_splitter_position, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, position, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, ratio_mode, MAY_BE_BOOL|MAY_BE_NULL, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_get_splitter_position, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, ratio_mode, MAY_BE_BOOL|MAY_BE_NULL, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_splitter_panes, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, splitter, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, pane1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, pane2, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_splitter_minsize, 0, 3, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, splitter, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, min_pane1, IS_LONG, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_create_popup_menu, 0, 1, MAY_BE_NULL|MAY_BE_LONG)
	ZEND_ARG_TYPE_INFO(0, menu_items, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_track_popup_menu, 0, 2, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, popup_menu, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, wbObjectParent, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, x, MAY_BE_NULL|MAY_BE_LONG, "-1")
	ZEND_ARG_TYPE_MASK(0, y, MAY_BE_NULL|MAY_BE_LONG, "-1")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_get_font, 0, 1, MAY_BE_BOOL|MAY_BE_ARRAY)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_sys_dlg_open, 0, 1, MAY_BE_STRING|MAY_BE_ARRAY)
	ZEND_ARG_TYPE_INFO(0, wbObjectParent, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, title, MAY_BE_NULL|MAY_BE_STRING, "\"\"")
	ZEND_ARG_TYPE_MASK(0, filter, MAY_BE_NULL|MAY_BE_STRING|MAY_BE_ARRAY, "\"\"")
	ZEND_ARG_TYPE_MASK(0, path, MAY_BE_NULL|MAY_BE_STRING, "\"\"")
	ZEND_ARG_TYPE_MASK(0, style, MAY_BE_NULL|MAY_BE_LONG, "0")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_task_run, 0, 2, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, wbObject, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, command, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, estimated_ms, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_wb_task_poll, 0, 1, MAY_BE_NULL|MAY_BE_ARRAY)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_set_chart_data, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
	ZEND_ARG_ARRAY_INFO(0, series, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_chart_set_data, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
	ZEND_ARG_ARRAY_INFO(0, series, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_chart_set_options, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
	ZEND_ARG_ARRAY_INFO(0, options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_chart_set_colors, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
	ZEND_ARG_ARRAY_INFO(0, palette, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_wb_chart_redraw, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, chart, IS_LONG, 0)
ZEND_END_ARG_INFO()
