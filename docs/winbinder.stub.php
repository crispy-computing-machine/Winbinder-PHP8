...
const Accel = 8;
const Calendar = 9;
const DateTimePicker = 10;
const CheckBox = 11;
const ComboBox = 12;
const EditBox = 13;
const Frame = 14;
const Gauge = 15;
const HTMLControl = 16;
const HyperLink = 17;
const ImageButton = 18;
const InvisibleArea = 19;
const Label = 20;
const ListBox = 21;
const ListView = 22;
const Menu = 23;
...
const WBC_PANEL_EXPANDED = 2097152;
const WBC_PANEL_COLLAPSED = 4194304;
const WBC_DTP_ISO = 2097152;
...
/**
 * Gets the selected date/time value from a DateTimePicker control.
 *
 * @param int $wbObject
 * @param bool $as_iso_string
 * @return int|string|null
 */
function wb_get_datetime(int $wbObject, bool $as_iso_string = false): int|string|null
{
}

/**
 * Sets the selected date/time value on a DateTimePicker control.
 *
 * @param int $wbObject
 * @param int|string|null $datetime_value
 * @return bool
 */
function wb_set_datetime(int $wbObject, int|string|null $datetime_value = 0): bool
{
}

/**
 * Gets min/max bounds from a DateTimePicker control.
 *
 * @param int $wbObject
 * @param bool $as_iso_string
 * @return array|null
 */
function wb_get_datetime_bounds(int $wbObject, bool $as_iso_string = false): ?array
{
}

/**
 * Sets min/max bounds on a DateTimePicker control.
 *
 * @param int $wbObject
 * @param int|string|null $min_datetime
 * @param int|string|null $max_datetime
 * @return bool
 */
function wb_set_datetime_bounds(int $wbObject, int|string|null $min_datetime = 0, int|string|null $max_datetime = 0): bool
{
}

/**
 * Gets the display format used by a DateTimePicker control.
 *
 * @param int $wbObject
 * @return string|null
 */
function wb_get_datetime_format(int $wbObject): ?string
{
}

/**
 * Sets the display format used by a DateTimePicker control.
 *
 * @param int $wbObject
 * @param string $format
 * @return bool
 */
function wb_set_datetime_format(int $wbObject, string $format): bool
{
}

/**
 * Gets whether the DateTimePicker currently has an empty value.
 *
 * @param int $wbObject
 * @return bool
 */
function wb_get_datetime_empty(int $wbObject): bool
{
}

/**
 * Sets whether the DateTimePicker currently has an empty value.
 *
 * @param int $wbObject
 * @param bool $empty
 * @return bool
 */
function wb_set_datetime_empty(int $wbObject, bool $empty): bool
{
}
/**
...
/**
 * Attach tooltip to control for mouse over display
 * @param int $wbObject
 * @param string|null $text
 * @return bool
 */
function wb_attach_tooltip(int $wbObject, ?string $text = '') : bool{}
 ...
 * @return bool
 */
function wb_remove_tooltip(int $wbObject) : bool{}

/**
 * Display a tooltip baloon next to the wbObject
 *
 * @param int $wbObject
 * @param string $text
 * @param string|int|null $severity
 * @param string|null $title
 * @return bool
 */
function wb_show_tooltip_balloon(int $wbObject, string $text, string|int|null $severity = 'info', ?string $title = '') : bool{}

/**
 * Hide a displayed tooltip
 *
 * @param int $wbObject
 * @return bool
 */
 ...
 * @return int
 */
function wb_track_popup_menu(int $popup_menu, int $wbObjectParent, ?int $x = -1, ?int $y = -1, ?int $flags = 0) : int{}
